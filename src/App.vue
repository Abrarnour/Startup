...
onMounted(async () => {
  ...
  initLang()
  // Only load tenant data for actual school app routes (not platform, not registration)
  if (isSchool) {
    await loadTenant()
  } else {
    markLoaded()
        ...
        <div class="max-w-7xl mx-auto px-4 py-8">
          ...
          <div class="border-t border-gray-700 pt-6">
            <p class="text-gray-400 text-sm">
              &copy; 2025–2026 <br /><br />
              developed for BELMAHI SCHOOL. Unauthorized Reproduction, Distribution, or Commercial
              Use Prohibited<br />
              DEVELOPED by
              <a
