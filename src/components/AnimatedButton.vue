...
const props = defineProps({
  ...
  label1: { type: String, default: 'Commencer' },
  label2: { type: String, default: 'Maintenant' },
})
...
<template>
  <button class="anim-btn" @click="handle">
    <div class="bg"></div>
...
.bg::before {
  ...
  box-shadow:
    -7px 6px 0 0 rgb(2 85 174 / 40%),
    -14px 12px 0 0 rgb(2 85 174 / 30%),
    -21px 18px 4px 0 rgb(2 85 174 / 25%),
    -28px 24px 8px 0 rgb(2 85 174 / 15%),
    -35px 30px 12px 0 rgb(2 85 174 / 12%),
    -42px 36px 16px 0 rgb(2 85 174 / 8%),
    -56px 42px 20px 0 rgb(2 85 174 / 5%);
}
...
/* hover */
.anim-btn:hover .char.state-1 span::before {
  animation: charAppear 0.7s ease calc(var(--i) * 0.03s);
}
.anim-btn:hover .char.state-1 span::after {
  opacity: 1;
...
.anim-btn:hover .outline {
  opacity: 1;
}
.anim-btn:hover .outline::before,
.anim-btn:hover .icon div::before,
.anim-btn:hover .icon div::after,
.anim-btn:hover .icon div {
  animation-play-state: running;
}

/* active / press */
.anim-btn:active .bg::before {
  filter: blur(5px);
  opacity: 0.7;
  box-shadow:
    -7px 6px 0 0 rgb(2 85 174 / 40%),
    -14px 12px 0 0 rgb(2 85 174 / 25%),
    -21px 18px 4px 0 rgb(2 85 174 / 15%);
}
.anim-btn:active .content {
  box-shadow:
    inset -1px 12px 8px -5px rgba(2 85 174 / 40%),
    inset 0 -3px 8px 0 var(--blue-200);
}
.anim-btn:active .outline {
  opacity: 0;
}
.anim-btn:active .wrap {
  transform: translate(3px, -3px);
}
.anim-btn:active .splash {
  animation: splash 0.8s cubic-bezier(0.3, 0, 0, 1) forwards 0.05s;
}

/* focus — path trace + text swap + arrow fly */
.anim-btn:focus .path {
...
.char.state-2 span::after,
.anim-btn:focus .char.state-1 span {
  animation: charDisappear 0.5s ease forwards calc(var(--i) * 0.03s);
}
.anim-btn:focus .char.state-2 span::after {
