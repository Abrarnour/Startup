...
export const translations = {
  fr: {
    ...
    courses_of_student: 'Cours de : {name}',
    no_enrolled_courses_ar: 'Aucun cours enregistré.',
    status_label: 'Statut :',
    ...
    confirm_unenroll_student: "Êtes-vous sûr d'annuler l'inscription de cet étudiant à ce cours ?",
  ...
  ar: {
    ...
    stats_realtime_view: 'مدرسة بلماحي · عرض في الوقت الفعلي',
