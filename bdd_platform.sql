...
\restrict RazDhmgCpvhIWdaGNHJ57p1dTyEcLpN5auHgeMEEMQ9qY5dcKTnyEC0V7tF0lTD
...
CREATE TABLE public.tenants (
    ...
    db_name character varying(80) NOT NULL,
    plan_id integer,
    ...
    CONSTRAINT tenants_status_check CHECK (((status)::text = ANY ((ARRAY['trial'::character varying, 'active'::character varying, 'suspended'::character varying, 'cancelled'::character varying])::text[])))
);
...
5	trial	تجريبية	0.00	30	3	{"materials": false, "timetable": true, "notifications": false}	t	2026-05-23 10:47:20.980873
6	basic	أساسية	3000.00	150	10	{"materials": true, "timetable": true, "notifications": false}	t	2026-05-23 10:47:20.980873
7	pro	احترافية	6000.00	500	30	{"materials": true, "timetable": true, "notifications": true}	t	2026-05-23 10:47:20.980873
8	enterprise	مؤسسية	12000.00	9999	999	{"api": true, "materials": true, "timetable": true, "notifications": true}	t	2026-05-23 10:47:20.980873
\.
...
1	admin@platform.dz	$2b$10$cvZJy74eLdAJNafm6qs7neZqKBnk125DRd94jyUtxHzrKj.RgDkae	Super Admin	super_admin	t	2026-05-22 22:23:04.866702
\.
...
COPY public.tenants (id, slug, school_name, school_name_ar, logo_url, primary_color, secondary_color, db_name, plan_id, status, trial_ends_at, admin_email, admin_phone, city, country, onboarding_done, created_at, updated_at) FROM stdin;
\.
...
--
-- Name: tenants tenants_db_name_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
\unrestrict RazDhmgCpvhIWdaGNHJ57p1dTyEcLpN5auHgeMEEMQ9qY5dcKTnyEC0V7tF0lTD
